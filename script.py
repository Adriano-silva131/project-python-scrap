...
# Converter a lista de dados extraídos em um DataFrame do pandas
df_all_data = pd.DataFrame(all_data)

# Salvar os dados consolidados em uma nova planilha
